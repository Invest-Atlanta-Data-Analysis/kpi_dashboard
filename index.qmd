...
tot_inv <- data.frame(name = c("2026 YTD", "2026 Goal"), inv = c(464875663.63, 900000000))
...
sb_inv <- data.frame(name = c("2026 YTD", "2026 Goal"), inv = c(2022451.98, 8500000))

sb_support <- data.frame(name = c("2026 YTD", "2026 Goal"), support = c(601, 1000))
...
nb_res <- data.frame(name = c("2026 YTD", "2026 Goal"), ppl = c(10413, 10000))
...
hs_ahu <- data.frame(name = c("2026 YTD", "2026 Goal"), inv = c(328, 1100))

hs_ho <- data.frame(name = c("2026 YTD", "2026 Goal"), support = c(135, 363))
...
units <- data.frame(years = c('2018','2019', '2020', '2021', '2022', '2023', '2024', '2025', '2026'),
                    aff = c(57.3, 55.5, 83.7, 83.0, 94.6, 85.9, 91, 84.1, 88.4))
...
biz_dev <- data.frame(name = c("2026 YTD", "2026 Goal"), closed = c(28, 40))

new_jobs <- data.frame(name = c("2026 YTD", "2026 Goal"), jobs = c(1602, 3000))
