...
tot_inv <- data.frame(name = c("2026 YTD", "2026 Goal"), inv = c(478901943.63, 900000000))
...
#events_plot
```
[![Click the image to explore our interactive online investment map](wins_map_20260710.png){width=51%}](https://iatl.maps.arcgis.com/apps/instant/basic/index.html?appid=112649da7b1d4fa58098c16cc402dcc4){target="_blank"}
...
sb_inv <- data.frame(name = c("2026 YTD", "2026 Goal"), inv = c(2422451.98, 8500000))

sb_support <- data.frame(name = c("2026 YTD", "2026 Goal"), support = c(668, 1000))
...
nb_res <- data.frame(name = c("2026 YTD", "2026 Goal"), ppl = c(11558, 10000))
...
nbres_plot <- ggplot(nb_res) +
  ...
  scale_x_discrete(name = " ", limits = c("2026 YTD", "2026 Goal")) +
  scale_y_continuous(name = "Attendees", limits = c(0,12000), 
                     expand = c(0,0), labels = scales::comma) +
  scale_fill_manual(values = c("#7dbf52", "#009ade")) +
  plot_theme()
nbres_plot
...
hs_ahu <- data.frame(name = c("2026 YTD", "2026 Goal"), inv = c(354, 1100))

hs_ho <- data.frame(name = c("2026 YTD", "2026 Goal"), support = c(119, 363))
...
units <- data.frame(years = c('2018','2019', '2020', '2021', '2022', '2023', '2024', '2025', '2026'),
                    aff = c(57.3, 55.5, 83.7, 83.0, 94.6, 85.9, 91, 84.1, 89.1))
...
biz_dev <- data.frame(name = c("2026 YTD", "2026 Goal"), closed = c(31, 40))

new_jobs <- data.frame(name = c("2026 YTD", "2026 Goal"), jobs = c(1773, 3000))

good_jobs <- data.frame(name = c("2026 YTD", "2026 Goal"), good = c(363, 1000))
