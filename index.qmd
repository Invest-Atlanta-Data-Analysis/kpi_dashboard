...
tot_inv <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(976015043.01, 930000000))

ce_events <- data.frame(name = c("2025 YTD", "2025 Goal"), people = c(4.67, 4.3))
...
#events_plot
```
[![Click the image to explore our interactive online investment map](wins_map_20251008.png){width=55%}](https://iatl.maps.arcgis.com/apps/instant/basic/index.html?appid=112649da7b1d4fa58098c16cc402dcc4){target="_blank"}
...
sb_inv <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(8270209, 8500000))

sb_support <- data.frame(name = c("2025 YTD", "2025 Goal"), support = c(882, 1000))
...
nb_res <- data.frame(name = c("2025 YTD", "2025 Goal"), ppl = c(14815, 9000))
...
nbres_plot <- ggplot(nb_res) +
  ...
  scale_x_discrete(name = " ", limits = c("2025 YTD", "2025 Goal")) +
  scale_y_continuous(name = "Attendees", limits = c(0,15000), 
                     expand = c(0,0), labels = scales::comma) +
  scale_fill_manual(values = c("#c8df8e", "#5e9732")) +
  plot_theme()
nbres_plot
...
hs_ahu <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(1180, 1900))

hs_ho <- data.frame(name = c("2025 YTD", "2025 Goal"), support = c(618, 400))
...
units <- data.frame(years = c('2018','2019', '2020', '2021', '2022', '2023', '2024', '2025'),
                    aff = c(57.3, 55.5, 83.7, 83.0, 94.6, 85.9, 91, 80.8))
...
biz_dev <- data.frame(name = c("2025 YTD", "2025 Goal"), closed = c(38, 30))

new_jobs <- data.frame(name = c("2025 YTD", "2025 Goal"), jobs = c(3094, 3500))

good_jobs <- data.frame(name = c("2025 YTD", "2025 Goal"), good = c(395, 1300))
...
bizdev_plot <- ggplot(biz_dev) +
  ...
  scale_y_continuous(name = "Number of Closed Projects", limits = c(0,40), 
                     expand = c(0,0), labels = scales::comma) +
  scale_fill_manual(values = c("#009ddc", "#002d56")) +
  plot_theme()
#bizdev_plot
