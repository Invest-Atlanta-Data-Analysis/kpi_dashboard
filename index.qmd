...
tot_inv <- data.frame(name = c("2024 YTD", "2024 Goal"), inv = c(1533646993.48, 1487100000))
...
sb_inv <- data.frame(name = c("2024 YTD", "2024 Goal"), inv = c(14799350, 6000000))

sb_support <- data.frame(name = c("2024 YTD", "2024 Goal"), support = c(1845, 1500))

sb_ta <- data.frame(name = c("2024 YTD", "2024 Goal"), hours = c(3798.45, 2750))
...
nb_dn <- data.frame(name = c("2024 YTD", "2024 Goal"), inv = c(61, 50))

nb_tad <- data.frame(name = c("Invest Atlanta", "Total Capital Investment"), 
                     support = c(59601437, 169644530))

nb_res <- data.frame(name = c("2024 YTD", "2024 Goal"), hours = c(9751, 9000))
...
hs_ahu <- data.frame(name = c("2024 YTD", "2024 Goal"), inv = c(2475, 2600))

hs_ho <- data.frame(name = c("2024 YTD", "2024 Goal"), support = c(409, 175))
...
biz_dev <- data.frame(name = c("2024 YTD", "2024 Goal"), closed = c(47, 30))

new_jobs <- data.frame(name = c("2024 YTD", "2024 Goal"), jobs = c(4250, 5000))

good_jobs <- data.frame(name = c("2024 YTD", "2024 Goal"), good = c(1670, 1500))
