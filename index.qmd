...
tot_inv <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(1573895546.48, 930000000))

ce_events <- data.frame(name = c("2025 YTD", "2025 Goal"), people = c(4.76, 4.3))
...
sb_inv <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(14799350, 8500000))

sb_support <- data.frame(name = c("2025 YTD", "2025 Goal"), support = c(1845, 1000))

sb_ta <- data.frame(name = c("2025 YTD", "2025 Goal"), hours = c(3798.45, 400))
...
nb_res <- data.frame(name = c("2025 YTD", "2025 Goal"), ppl = c(9751, 9000))

nbdn_plot <- ggplot(nb_dn) +
  geom_bar(aes(x = "", y = prop, fill = Location), color = "#000000", 
           stat = "identity", width = 1, show.legend = TRUE) +
  coord_polar("y", start = 0) +
  geom_text(aes(x = "", y = ypos, label = label), size = 8, color = "white") +
  scale_fill_manual(values = c("#009ddc", "#002d56")) +
  theme_void() +
...
nbtad_plot <- ggplot(nb_tad) +
  ...
  scale_y_continuous(name = "Investment ($)", limits = c(0,500000000), 
                     expand = c(0,0), labels = scales::comma) +
  scale_fill_manual(values = c("#5e9732", "#c8df8e")) +
  plot_theme()
nbtad_plot
...
hs_ahu <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(2475, 1900))

hs_ho <- data.frame(name = c("2025 YTD", "2025 Goal"), support = c(409, 400))
...
new_jobs <- data.frame(name = c("2025 YTD", "2025 Goal"), jobs = c(4433, 3500))

good_jobs <- data.frame(name = c("2025 YTD", "2025 Goal"), good = c(1675, 1300))
