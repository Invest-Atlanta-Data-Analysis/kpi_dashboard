...
```{r}
#| content: valuebox
#| title: "Total Investment to Disinvested Neighborhoods"
list(
  icon = "globe-americas",
  color = "primary",
  value = "46.3%"
...
tot_inv <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(1726921850.43, 930000000))
...
sb_inv <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(10065209, 8500000))
...
hs_ho <- data.frame(name = c("2025 YTD", "2025 Goal"), support = c(576, 400))
...
hsho_plot <- ggplot(hs_ho) +
  geom_col(aes(x = name, y = support, fill = name), color = "#000000", show.legend = FALSE) +
  scale_x_discrete(name = " ", limits = c("2025 YTD", "2025 Goal")) +
  scale_y_continuous(name = "Number of Homeowners", limits = c(0,680), 
                     expand = c(0,0), labels = scales::comma) +
  scale_fill_manual(values = c("#5e9732", "#c8df8e")) +
  plot_theme()
hsho_plot
