...
tot_inv <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(1725012352.43, 930000000))
...
sb_inv <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(9844209, 8500000))

sb_support <- data.frame(name = c("2025 YTD", "2025 Goal"), support = c(1083, 1000))
...
sbinv_plot <- ggplot(sb_inv) +
  ...
  scale_y_continuous(name = "Direct Investment ($)", limits = c(0,10000000), 
                     expand = c(0,0), labels = scales::comma) +
