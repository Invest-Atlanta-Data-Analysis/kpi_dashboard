...
tot_inv <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(1256764046.29, 930000000))

ce_events <- data.frame(name = c("2025 YTD", "2025 Goal"), people = c(4.7, 4.3))
...
totinv_plot <- ggplot(tot_inv) +
  ...
  scale_y_continuous(name = "$ Invested", limits = c(0,1300000000), 
...
#events_plot
```
[![Click the image to explore our interactive online investment map](wins_map_20251008.png){width=51%}](https://iatl.maps.arcgis.com/apps/instant/basic/index.html?appid=112649da7b1d4fa58098c16cc402dcc4){target="_blank"}
...
sb_inv <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(9797209, 8500000))

sb_support <- data.frame(name = c("2025 YTD", "2025 Goal"), support = c(979, 1000))

sb_ta <- data.frame(name = c("2025 YTD", "2025 Goal"), hours = c(131.5, 400))
...
nb_tad <- data.frame(Funding = c("Invest Atlanta Investment", "Leveraged Capital Investment"), 
                     support = c(31403000, 262593205))

nb_res <- data.frame(name = c("2025 YTD", "2025 Goal"), ppl = c(19638, 9000))
...
nbres_plot <- ggplot(nb_res) +
  ...
  scale_x_discrete(name = " ", limits = c("2025 YTD", "2025 Goal")) +
  scale_y_continuous(name = "Attendees", limits = c(0,20000), 
                     expand = c(0,0), labels = scales::comma) +
  scale_fill_manual(values = c("#c8df8e", "#5e9732")) +
  plot_theme()
nbres_plot
...
hsho_plot <- ggplot(hs_ho) +
  geom_col(aes(x = name, y = support, fill = name), color = "#000000", show.legend = FALSE) +
  scale_x_discrete(name = " ", limits = c("2025 YTD", "2025 Goal")) +
  scale_y_continuous(name = "Number of Homeowners", limits = c(0,650), 
                     expand = c(0,0), labels = scales::comma) +
  scale_fill_manual(values = c("#5e9732", "#c8df8e")) +
  plot_theme()
hsho_plot
...
units <- data.frame(years = c('2018','2019', '2020', '2021', '2022', '2023', '2024', '2025'),
                    aff = c(57.3, 55.5, 83.7, 83.0, 94.6, 85.9, 91, 82.2))
...
biz_dev <- data.frame(name = c("2025 YTD", "2025 Goal"), closed = c(44, 30))

new_jobs <- data.frame(name = c("2025 YTD", "2025 Goal"), jobs = c(3896, 3500))
