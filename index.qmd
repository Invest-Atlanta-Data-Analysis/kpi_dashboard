...
tot_inv <- data.frame(name = c("2026 YTD", "2026 Goal"), inv = c(261845268.6, 900000000))
...
sb_inv <- data.frame(name = c("2026 YTD", "2026 Goal"), inv = c(1795658.98, 8500000))

sb_support <- data.frame(name = c("2026 YTD", "2026 Goal"), support = c(508, 1000))
...
nb_res <- data.frame(name = c("2026 YTD", "2026 Goal"), ppl = c(8848, 10000))
...
hs_ho <- data.frame(name = c("2026 YTD", "2026 Goal"), support = c(120, 363))
...
biz_dev <- data.frame(name = c("2026 YTD", "2026 Goal"), closed = c(27, 40))

new_jobs <- data.frame(name = c("2026 YTD", "2026 Goal"), jobs = c(1442, 3000))

good_jobs <- data.frame(name = c("2026 YTD", "2026 Goal"), good = c(63, 1000))
