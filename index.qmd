...
tot_inv <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(235039146.82, 930000000))

ce_events <- data.frame(name = c("2025 YTD", "2025 Goal"), people = c(4.46, 4.3))
...
#events_plot
```
[![Click the image to explore our interactive online investment map](wins_map_20250409.jpg){width=55%}](https://iatl.maps.arcgis.com/apps/instant/basic/index.html?appid=112649da7b1d4fa58098c16cc402dcc4){target="_blank"}
...
sb_inv <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(1005500, 8500000))

sb_support <- data.frame(name = c("2025 YTD", "2025 Goal"), support = c(264, 1000))
...
```{r}
#| content: valuebox
#| title: "TAD Deal Leveraged Capital"
list(
  icon = "door-open", 
  color = "primary", 
  value = "$57.6 Million"
...
nb_tad <- data.frame(name = c("Invest Atlanta", "Total Capital Investment"), 
                     support = c(650000, 83649315.07))

nb_res <- data.frame(name = c("2025 YTD", "2025 Goal"), ppl = c(3566, 9000))
...
nbtad_plot <- ggplot(nb_tad) +
  ...
  scale_y_continuous(name = "Investment ($)", limits = c(0,90000000), 
                     expand = c(0,0), labels = scales::comma) +
  scale_fill_manual(values = c("#5e9732", "#c8df8e")) +
  plot_theme()
nbtad_plot
...
nbres_plot <- ggplot(nb_res) +
  ...
  scale_x_discrete(name = " ", limits = c("2025 YTD", "2025 Goal")) +
  scale_y_continuous(name = "Attendees", limits = c(0,9100), 
                     expand = c(0,0), labels = scales::comma) +
  scale_fill_manual(values = c("#002d56", "#009ddc")) +
  plot_theme()
nbres_plot
...
hs_ahu <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(191, 1900))

hs_ho <- data.frame(name = c("2025 YTD", "2025 Goal"), support = c(64, 400))
...
units <- data.frame(years = c('2018','2019', '2020', '2021', '2022', '2023', '2024', '2025'),
                    aff = c(57.3, 55.5, 83.7, 83.0, 94.6, 85.9, 91,100))
...
biz_dev <- data.frame(name = c("2025 YTD", "2025 Goal"), closed = c(8, 30))

new_jobs <- data.frame(name = c("2025 YTD", "2025 Goal"), jobs = c(257, 3500))

good_jobs <- data.frame(name = c("2025 YTD", "2025 Goal"), good = c(141, 1300))
...
sectors <- data.frame(Industry = c("Technology", "Retail and Food", "Other Professional Services"), 
                      total = c(.25, .375, .375))
