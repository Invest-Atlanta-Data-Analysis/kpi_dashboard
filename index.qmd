...
tot_inv <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(1364028111.29, 930000000))
...
totinv_plot <- ggplot(tot_inv) +
  ...
  scale_y_continuous(name = "$ Invested", limits = c(0,1400000000), 
...
sb_inv <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(9809709, 8500000))

sb_support <- data.frame(name = c("2025 YTD", "2025 Goal"), support = c(1012, 1000))
...
nb_tad <- data.frame(Funding = c("Invest Atlanta Investment", "Leveraged Capital Investment"), 
                     support = c(33915500, 315712510.07))

nb_res <- data.frame(name = c("2025 YTD", "2025 Goal"), ppl = c(23570, 9000))

aemi_res <- data.frame(name = c("2025 YTD", "2025 Goal"), ppl = c(8055, 10000))
...
nbtad_plot <- ggplot(nb_tad) +
  ...
  scale_y_continuous(name = "Investment ($)", limits = c(0,350000000), 
                     expand = c(0,0), labels = scales::comma) +
  scale_fill_manual(values = c("#5e9732", "#c8df8e")) +
  plot_theme()
#nbtad_plot
...
nbres_plot <- ggplot(nb_res) +
  ...
  scale_x_discrete(name = " ", limits = c("2025 YTD", "2025 Goal")) +
  scale_y_continuous(name = "Attendees", limits = c(0,30000), 
                     expand = c(0,0), labels = scales::comma) +
  scale_fill_manual(values = c("#c8df8e", "#5e9732")) +
  plot_theme()
nbres_plot
...
hs_ahu <- data.frame(name = c("2025 YTD", "2025 Goal"), inv = c(1417, 1900))

hs_ho <- data.frame(name = c("2025 YTD", "2025 Goal"), support = c(634, 400))
...
hsho_plot <- ggplot(hs_ho) +
  geom_col(aes(x = name, y = support, fill = name), color = "#000000", show.legend = FALSE) +
  scale_x_discrete(name = " ", limits = c("2025 YTD", "2025 Goal")) +
  scale_y_continuous(name = "Number of Homeowners", limits = c(0,700), 
                     expand = c(0,0), labels = scales::comma) +
  scale_fill_manual(values = c("#5e9732", "#c8df8e")) +
  plot_theme()
hsho_plot
...
units <- data.frame(years = c('2018','2019', '2020', '2021', '2022', '2023', '2024', '2025'),
                    aff = c(57.3, 55.5, 83.7, 83.0, 94.6, 85.9, 91, 84))
...
new_jobs <- data.frame(name = c("2025 YTD", "2025 Goal"), jobs = c(3966, 3500))
